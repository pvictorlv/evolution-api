        ...
        if (contactsRaw.length > 0) {
          ...
          if (this.configService.get<Database>('DATABASE').SAVE_DATA.CONTACTS) {
            try {
              ...
              this.logger.error(`Error saving contacts: ${error.message}`);
            }
          }
      ...
      try {
        for (const received of messages) {
          ...
          if (
            ...
            console.log('protocolMessage or pollUpdateMessage or empty message, ignored', received.message?.peerDataOperationRequestResponseMessage);
            continue;
          }
          ...
          if (this.configService.get<Database>('DATABASE').SAVE_DATA.NEW_MESSAGE) {
            ...
            try {
              ...
              this.logger.error('Error on new message insert: ' + e.toString());
              console.trace(e);
            }
          ...
          if (update.message === null && update.status === undefined) {
            ...
            if (this.configService.get<Database>('DATABASE').SAVE_DATA.MESSAGE_UPDATE) {
              try {
                ...
                this.logger.error(['Error on insert message update record', error?.message, error?.stack]);
              }
            }
